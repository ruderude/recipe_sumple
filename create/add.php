...
if (isset($_FILES['upfile']['error']) && is_int($_FILES['upfile']['error'])) {
    ...
    try {
        ...
        // INSERT処理
        $stmt = $dbh->prepare('INSERT INTO recipes(recipe_name, category, difficulty, budget, howto, user_name, image_name,type,raw_data,thumb_data,date) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
            ...
            $stmt->bindValue(11, (new DateTime('now', new DateTimeZone('Asia/Tokyo')))->format('Y-m-d H:i:s'));
            $stmt->execute();
...
<html lang="ja">
<head>
<title>RUDEお料理レシピの鉄人：新規作成</title>
<meta charset="utf-8">
